package ru.nekit.planEditor.serviceCore.serviceUtil{
	...
	import ru.nekit.planEditor.serviceCore.events.ServiceEvent;
	...
	import ru.nekit.planEditor.util.gc.GC;
	...
	final public class AMFServiceUtil extends ServiceUtil implements IServiceUtil{
		...
		private var timer:Timer = new Timer(MAX_EXECUTE_TIME*100000);
